  ...
  return (
    <>
        ...
        <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50
            ...
            <a href='#top'>
                <Image src={isDarkMode ? assets.logo_dark_f : assets.logo_f} alt=''  className='w-28  alt="" cursor-pointer mr-14' /> {/* TO DO: faire un logo avec mon prénom en fond transparent et faire un logo pour le darkmode avec text en blanc */}
            </a>

            <ul className={`hidden md:flex items-center gap-6 lg:gap-8
            rounded-full px-12 py-3 ${isScroll ? "" : "bg-white shadow-sm bg-opacity-50 dark:border dark:border-white/50 dark:bg-transparent"} `}> {/* opacité de l'arrière plan 50 */} 
