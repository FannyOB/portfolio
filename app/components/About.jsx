    ...
    <div id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <h2 className='text-center text-5xl font-Ovo'>About me</h2>
        ...
        <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-12'>
            ...
            <div className='w-64 sm:w-auto rounded-3xl max-w-none'>
            ...
            <div className='flex-1'>
                ...
                <h4 className='my-4 text-gray-700 font-Ovo dark:text-white'>Tools I use</h4>

                <ul className='flex items-center gap-3 sm:gap-5'>
                    {toolsData.map((tool, index) =>(
                        <li className='flex items-center justify-center w-12 sm:-14 aspect-square border border-gray-400 
