  ...
  return (
    <div id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
        Welcome to my web development portfolio! Here you can find some of the projects I have worked on.
      </p>

      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 my-10 gap-5 dark:text-black'>
