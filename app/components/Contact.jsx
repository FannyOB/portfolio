  ...
  return (
    ...
    bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto]'>
      ...
      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
        I am always open to new opportunities and collaborations. <br/>If you have a have any questions, feedback or just want to chat, please use the form below.
      </p>
      ...
      <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        <p className='mt-4'>{result}</p> {/* plus tard, Afficher le message de résultat dans un badge shadcn.ui*/} 
      </form>
    </div>
  )
}
